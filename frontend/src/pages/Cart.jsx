      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        {items.length === 0 ? (
          <div className="text-center py-20 animate-fade-in">
            <ShoppingBag size={64} className="mx-auto mb-6" style={{ color: 'var(--text-tertiary)' }} />
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
              ...
              {items.map((item) => {
                ...
                return (
                  <div
                    ...
                    className="flex gap-4 p-4 rounded-[var(--radius-lg)] border transition-all animate-fade-in"
                    style={{
                  ...
                  >
                    {/* Image */}
                    <div
                      className="w-20 h-20 sm:w-24 sm:h-24 rounded-[var(--radius-md)] overflow-hidden flex-shrink-0"
                    ...
                    <div className="flex-1 min-w-0">
                      ...
                      <div className="flex items-center gap-3 mt-3">
                        ...
                        <button
                          ...
                          className="p-2 rounded-[var(--radius-sm)] cursor-pointer transition-colors"
            ...
            <div>
              ...
              >
                ...
                <div
                  className="flex justify-between py-4 border-t text-lg font-bold"
